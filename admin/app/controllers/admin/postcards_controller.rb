  ...
  class PostcardsController < Admin::StatementsController
    ...
    def show
      if params[:add_mailing_category].present? \
          && @user&.main_address \
          && !@user.mailings.find_by(category: params[:add_mailing_category], sent: params[:add_mailing_sent].presence)
        @user.mailings.create!(category: params[:add_mailing_category], sent: params[:add_mailing_sent].presence, address: @user.main_address)
      end
