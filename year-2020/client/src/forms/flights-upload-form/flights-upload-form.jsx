...
export default class FlightsUploadForm extends LegalUploadForm {
  constructor(props) {
    super(props)
    this.state = {
      submitting: false,
  ...
  action            = () => `/admin/users/${this.props.dus_id}/flight_proofs`

  deleteFileAction  = (id) => `${this.action()}/${id || ''}`

  endpointAttribute = () => 'flight_proofs'

  directUploadsPath = () => `/rails/active_storage/direct_uploads/flight_proofs/${this.props.dus_id}`
