...
import OverPaymentForm from 'common/js/forms/over-payment-form'
import { CardSection } from 'react-component-templates/components';

export default class OverPaymentPage extends Component {
  constructor(props){
    super(props)
    this.state = {}
  }
    ...
    return (
      ...
      >
        <div className="list-group-item">
          {
            this.state.dus_id ? (
              <OverPaymentForm id={this.props.match.params.userId} {...this.state} onSuccess={this.backToChecklist} />
            ) : (
              <>
                Please contact a Down Under Sports representative for your over-payment link.
                <ul>
