...
// import TravelInfoForm from 'common/js/forms/travel-info-form'
import VisaForm from 'common/js/forms/visa-form'
import { CardSection } from 'react-component-templates/components';

export default class TravelInfoPage extends Component {
  constructor(props){
    super(props)
    this.state = {}
  }
  ...
  render() {
    return (
      ...
      >
        {
          this.state.dus_id ? (
            <VisaForm id={this.props.match.params.userId} {...this.state} onComplete={this.backToChecklist} />
          ) : (
