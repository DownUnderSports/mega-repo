class AddCallsEmailsToUserTravelPreparations < ActiveRecord::Migration[5.2]
  def up
    set_db_year "public"
    #==== GET INDEXES ===
    <<-SQL
    ...
    %w[
      ...
      execute "DROP TRIGGER IF EXISTS audit_trigger_row ON #{year}.user_travel_preparations;"
      execute "DROP TRIGGER IF EXISTS audit_trigger_stm ON #{year}.user_travel_preparations;"
      execute "ALTER TABLE #{year}.user_travel_preparations DROP CONSTRAINT IF EXISTS #{year}_user_travel_preparations_pkey;"
      execute "ALTER TABLE public.user_travel_preparations DROP CONSTRAINT IF EXISTS user_travel_preparations_pkey;"
    ...
    create_table :user_travel_preparations do |t|
      ...
      t.jsonb :calls, null: false, default: {}
      t.jsonb :confirmations, null: false, default: {}
      t.jsonb :deadlines, null: false, default: {}
    ...
    BetterRecord::LoggedAction.where(table_name: :user_travel_preparations).split_batches_values do |utp|
      utp.row_data["calls"] = {}
      utp.save!
    end
