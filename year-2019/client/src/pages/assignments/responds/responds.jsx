...
const assignmentsUrl = `${canUseDOM ? '' : 'http://localhost:3000'}/admin/assignments/responds`,
      headers = [
        'assigned_to',
        'locked',
        'visited',
  ...
  renderButtons = ({getParams, getRecordCount, reload}) => (
    <div key="renderedButtonsWrapper" className="row mb-3">
      <div key="csvDownloadWrapper" className="col-auto">
        <FileDownload key="csvDownload" path={`${assignmentsUrl}.csv`}>
      ...
      <div key="assignmentFormWrapper" className="col">
        <AssignmentsUploadForm key="assignmentUploadForm" url={assignmentsUrl} />
      </div>
