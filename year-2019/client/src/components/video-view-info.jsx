...
export default class RegistrationInfo extends Component {
  ...
  copyLink = (e) => {
    e.preventDefault()
    e.stopPropagation()
    CopyClip.prompted(`https://downundersports.com/videos/${String(this.props.category)[0]}/${this.props.user_id}`)
  }
              ...
              <tbody>
                <tr>
                  ...
                  <td className="copyable" onClick={this.copyLink}>
                    https://downundersports.com/videos/{String(category)[0]}/{user_id}
                  </td>
                </tr>
                <tr>
                  <td colSpan="2"></td>
